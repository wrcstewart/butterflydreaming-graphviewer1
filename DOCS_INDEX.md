...
| ✔ **speech_plan.md** | 09-03 | The staged plan for in-browser speech. Stages 0 and 1 are built and shipped; read with `voice_training_pipeline.md`. |
| ✔ **ink_promotion_plan.md** | 09-04 | Plan for making the achromatic model the default. **Stage 1 done 2026-09-06** — the plain URL is now achromatic and `?ink=0` returns the coloured model. Stage 2, walking every view, is still worth doing. |
| ✔ **voice_training_pipeline.md** | 09-06 | **As-built record of the voice-training pipeline** — recording rig, the first fine-tune, the seven toolchain breakages with their fixes, a re-runnable command block, and the plan for recording from the author's wife's own mindfulness writing. Read before any further voice work. |
...
`session_notes_2026-08-16_17.md` · `…08-19.md` · `…08-20.md` · `…08-21.md` · `…08-22_23.md` · `…08-24_25.md` · `…08-27.md` · `…08-28.md` · **`…09-01.md`** · **`…09-02.md`** · **`…09-03.md`** · **`…09-04.md`** · **`…09-05.md`**
